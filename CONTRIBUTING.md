# Contributing to Karida

First off, thank you for considering contributing to Karida!
We want to make contributing as approachable and transparent as possible.

## Code of Conduct

Karida has adopted a Code of Conduct that we expect contributors to adhere to.
Please [read the full text](https://github.com/karida-org/.github/blob/main/CODE_OF_CONDUCT.md)
...
Before we can include your contribution in the Karida project, you need to
...
By contributing to Karida, you agree that your contributions will be licensed
